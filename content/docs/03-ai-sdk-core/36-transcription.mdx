...
WebSocket STT transport. AssemblyAI likewise uses the same
`assemblyai.transcription('universal-3-5-pro')` model for both, plus the
streaming-only `universal-3-6-pro`, `universal-streaming-english`, and
`universal-streaming-multilingual` models.
...
| [AssemblyAI](/providers/ai-sdk-providers/assemblyai#streaming-transcription-models) | `universal-3-6-pro`                |
| [AssemblyAI](/providers/ai-sdk-providers/assemblyai#streaming-transcription-models) | `universal-streaming-english`      |
| [AssemblyAI](/providers/ai-sdk-providers/assemblyai#streaming-transcription-models) | `universal-streaming-multilingual` |
